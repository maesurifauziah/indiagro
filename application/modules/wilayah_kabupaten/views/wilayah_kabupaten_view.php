<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
						...
						<li class="breadcrumb-item">
							<a href="" class="text-muted">Wilayah Kabupaten</a>
						</li>
					</ul>
					<!--end::Breadcrumb-->
	...
	<div class="d-flex flex-column-fluid">
		...
		<div class="container">
			<!--begin::Card-->
			<div class="card card-custom" style="margin-bottom: 75px;">
					...
					<form class="mb-15">
						<div class="row mb-6">
                            <div class="col-lg-3 mb-lg-0 mb-6">
								...
								<input type="text" class="form-control" id="filter_kabupaten_kota">
							</div>
							<div class="col-lg-3 mb-lg-0 mb-6">
								<label>Status:</label>
	...
	<div class="modal-dialog modal-dialog-centered modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Form Wilayah Kabupaten</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
			<?= form_open('wilayah_kabupaten/save', array('id' => 'wilayah_kabupaten', 'class' => 'form')) ?>
			<input type="hidden" name="kabid" id="kabid" />
            <input type="hidden" name="type" id="type">
			<div class="modal-body">
				<div class="row">
                    <div class="col-sm-12">
                        <label>Tipe</label>
                        <select class="form-control" name="tipe_kab_kota" id="tipe_kab_kota">
							<option value="">--Pilih Tipe--</option>
							<option value="kabupaten">Kabupaten</option>
							<option value="kota">Kota</option>
						</select>
                        <span id="tipe_kab_kota-error" class="error invalid-feedback" style="display: block;"></span>
                    </div>
                    <div class="col-sm-12">
                        <label>Nama Kota/Kabupaten</label>
                        <input type="text" class="form-control" name="kabupaten_kota" id="kabupaten_kota">
                        <span id="kabupaten_kota-error" class="error invalid-feedback" style="display: block;"></span>
                    </div>
                    <div class="col-sm-12">
