			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
						...
						<li class="breadcrumb-item">
							<a href="" class="text-muted">Wilayah Kecamatan</a>
						</li>
					</ul>
					<!--end::Breadcrumb-->
					...
					<form class="mb-15">
						<div class="row mb-6">
                            <div class="col-lg-3 mb-lg-0 mb-6">
								...
								<input type="text" class="form-control" id="filter_kecamatan">
							</div>
							<div class="col-lg-3 mb-lg-0 mb-6">
								<label>Status:</label>
	...
	<div class="modal-dialog modal-dialog-centered modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Form Wilayah Kecamatan</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
			<?= form_open('wilayah_kecamatan/save', array('id' => 'wilayah_kecamatan', 'class' => 'form')) ?>
			<input type="hidden" name="kecid" id="kecid" />
			...
			<div class="modal-body">
				<div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <span id="kecamatan-error" class="error invalid-feedback" style="display: block;"></span>
                    </div>
                    <div class="col-sm-12">
