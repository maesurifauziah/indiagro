			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
						...
						<li class="breadcrumb-item">
							<a href="" class="text-muted">Group User</a>
						</li>
					</ul>
					<!--end::Breadcrumb-->
...
<div class="modal fade" id="modal-form" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered modal-sm" role="document">
        <div class="modal-content">
			...
			<?= form_open('admin_group_user/save', array('id' => 'admin_group_user', 'class' => 'form')) ?>
			...
			<div class="modal-body">
				<div class="row">
                    <div class="col-sm-12">
                        ...
                        <span id="group_name-error" class="error invalid-feedback" style="display: block;"></span>
                    </div>
