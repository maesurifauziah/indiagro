...
class Transaksi_detail_admin_model extends CI_Model
{
    ...
    private function _get_datatables_query()
    {
        ...
        // if ($this->input->get('trans_id', true)) {
        ...
        $this->db->select('
                        ...
                        a.stock_id,
                        g.qty AS qty_stock,
                        h.nama_lengkap as nama_pemasok,
                        a.userid,
                        e.nama_lengkap,
                        a.detailid,
                        a.kategori_id,
        ...
        $this->db->join('stock_barang g', 'g.stock_id = a.stock_id', 'LEFT');
        $this->db->join('admin_user h', 'h.userid=g.userid', 'LEFT');
        $this->db->where('a.trans_id', $this->input->get('trans_id', true));
    ...
    { 
        ...
        $this->db->join('admin_user c', 'c.userid=a.userid', 'LEFT');
        $this->db->where('a.kode_jenis_barang', $kode_jenis_barang);
