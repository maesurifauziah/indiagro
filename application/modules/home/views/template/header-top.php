	...
	<div class="container">
		<div class="d-none d-lg-flex align-items-center mr-3">
			<a href="<?=base_url()?>" class="mr-5">
				<img alt="Logo" src="<?=base_url()?>assets/media/logo/logo_agro_indo2.png" class="max-h-35px" />
			</a>
		...
		<div class="topbar">
			<?php if ($this->session->userdata('user_group') == '0001' || $this->session->userdata('user_group') == '0005' || $this->session->userdata('user_group') == '0003') : ?>
				<div class="topbar-item">
					<a href="<?= base_url('keranjang') ?>" class="btn btn-icon btn-hover-transparent-white btn-dropdown btn-lg mr-1">
			...
			<div class="topbar-item">
				<div class="btn btn-icon btn-hover-transparent-white w-auto d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
					...
					<span class="symbol symbol-35">
						<div class="symbol-label" id="mini-photo" style="background-image: url(<?php echo $this->session->userdata('photo') == '' ? "assets/media/users/blank.png":"upload/admin_user/".$this->session->userdata('photo')?>)"></div>
					</span>
				</div>
			</div>
		</div>
